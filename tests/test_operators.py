...
def test_symmetric() -> None:
    ...
    """
    assert_close(mul(1.0, 4.0), mul(4.0, 1.0))
    assert_close(mul(-2.0, 5.0), mul(5.0, -2.0))
...
def test_distribute() -> None:
    ...
    """
    assert_close(mul(3.0, add(2.0, 4.0)), add(mul(3.0, 2.0), mul(3.0, 4.0)))
    assert_close(mul(-1.5, add(2.0, -4.0)), add(mul(-1.5, 2.0), mul(-1.5, -4.0)))
